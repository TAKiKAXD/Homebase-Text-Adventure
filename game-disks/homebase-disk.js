const homebaseDisk = () => ({
  ...
  rooms: [
      ...
      items: [
        {
          ...
          desc: '', 
          onUse: () => println(`The Mission Briefing Shows something about a mission you have never seen before.`), 
        },
        {
          name: 'Communication Device',
          desc: '', 
          onUse: () => println(`It dosn't look like it works.`), 
        },
      ],
      exits: [
        {
    ...
    },
    {
      ...
      desc: `This room looks to be full of smashed llama bits.`, 
      items: [
        {
          name: 'Smashed Head',
          desc: 'An old X-Ray llamas head', 
          onUse: () => println(`The old llama head looks at you`), 
          isTakeable: true,
          onTake() {
          println(`You took it.`);  
        ...
        {
          name: 'Broken Parts',
          desc: 'A bunch of llama parts mostly tails', 
          onUse: () => println(`Its a bunch of llama parts from a bunch of different llamas`), 
        },
      ],
      exits: [
        {
    ...
    },
    {
      ...
      items: [
        {
          name: 'Sword',
          desc: 'An old sword', 
          onUse: () => println(`The sword looks to be made of a old ruler`), 
          isTakeable: true,
          onTake() {
          println(`You took it.`);  
      ...
      {
        name: 'Door',
        desc: 'This door takes you to the weapon storage room', 
        onUse: () => println(`It's locked Clip must of locked it`), 
      },
      ],
      exits: [
        {
    ...
    },
    {
      id: 'hallway1',
      name: 'Hallway',
      desc: `It's a hallway at the south end is a wet floor sign to the west is a **STORAGE ROOM** and to the east is the **ARMORY** `,
      items: [
        {
          name: 'Map of Homebase',
          desc: 'Hand drawn map of Homebase', 
          onUse: () => println(`It's a badly drawn map of Homebase looks like denis was the one who made it`),
          isTakeable: true,
          onTake() {
          println(`You took it.`);  
  ...
  characters: [
    {
      name: ['Ray', 'Ray', '17'],
      roomId: 'commandcenter',
      desc: 'Ray gives you a thumbs up', 
      img: `                                     
                 ++++++++++++               
               +++++++++++++++++            
             ++##########-+++++++           
...
#####++++++ +##                       #+++++
 ...
 ###### ####+++               +++####++++#+ 
    ...
    },
    {
      name: ['Llama'],
      roomId: 'storageroom1',
      desc: 'The llama gives you a look that tells you to get out ', 
      img: `                                      
                   ....                         
                 ++#---..++##                   
               .#+#---.#++-#                    
